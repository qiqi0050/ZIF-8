...
%--------------------------------添加页面元素----------------------------%
\title{\sanhao 静电纺丝ZIF-8制备的Zn-N/C氧还原催化性能研究}
\author{
    \wuhao 刘超奇，高材1310，2013012431\\
    \wuhao 指导教师：马贵平，教授
}
\date{April,2017}
...
\begin{abstract}
    \xiaosihao 如今，化石能源--如石油、天然气与煤炭的广泛使用推动了人类社会的快速发展，但是化石能源的不可再生性以及使用过程带来的环境问题是人类面临的的两大难题。煤炭开采带来的水资源污染、水土流失问题，以及燃烧后产生的硫、氮氧化物是形成酸雨的主要原因。为了解决这一问题，人们正在逐步发展环保型能源如太阳能、风能、核能、以及燃料电池等新能源。其中燃料电池是一种不经过燃烧直接将化学能转化为电能的新型能量转换系统，两级分别由氢气和氧气做原料产物只有水，具有清洁高效、绿色环保的特点，但是目前还没有得到广泛应用的原因是它存在一些问题--阴极氧还原反应（ORR）相对于阳极反应缓慢，ORR决定了反应的速率，而目前最好的催化剂Pt太过于昂贵不能广泛应用以满足成本效益。所以，人们一直致力于发现非贵重催化剂来替代Pt。 这些替代的非贵金属催化剂包括过渡金属硫属元素化物，导电聚合物，金属氧化物，碳化物，氮化物，氮氧化物，碳氮化物等氮-碳（N-C）。其中，M-N/C类型的催化剂拥有较高的ORR活性，并且材料来源广泛，价钱平易近人，受到业内的广泛关注。金属有机骨架材料（MOFs）是由无机金属中心（金属离子或金属簇）与桥连的有机配体通过共价键或离子共价键连接形成的一类具有周期性网络结构的晶态多孔材料。MOFs是一种有机-无机杂化材料，也称配位聚合物(coordination polymer)，它既不同于无机多孔材料，也不同于一般的有机配合物。兼有无机材料的刚性和有机材料的柔性特征。使其在现代材料研究方面呈现出巨大的发展潜力和诱人的发展前景。ZIF-8是MOFs材料的一个子类，优点是它拥有含量较多的N原子、较高的比表面积、稳定的化学性能，是用来制备N掺杂多孔C材料的前驱体，因而被广泛的应用在氧还原反应（ORR）等领域。衍生自金属--有机骨架（MOFs）的氮和金属共掺杂碳的固有颗粒性质阻碍了其在氧还原反应（ORR）中的实际应用。本文中，我们开发了一种新型的含N，Zn2+的基于MOFs的分层碳纤维作为ORR催化剂。通过将Zn沸石咪唑化物框架（Zn-ZIF）与电纺聚丙烯腈纤维结合，合成产物ZIF-8—PAN纤维，并系统地研究了温度和前体对最终样品的ORR性能的影响。
\end{abstract}
...
\subsection{CPVC 简介}
氯化聚氯乙烯（CPVC），也称为过氯乙烯\cite{23}，是通过将聚氯乙烯（PVC）进一步氯化改性得到的产品。CPVC 最早由德国 \textit{I.G. Farben AG} 公司以溶液法制得。在 20 世纪 60 年代 初期，美国 \textit{Genova} 产品公司首次为冷热水分配系统制造了第一套 CPVC 管道和配件。而后，\textit{Genova} 与 CPVC 树脂的开发商 \textit{B.F. Goodrich} 公司合作开发了第一代用于 CPVC 黏合剂的四氢呋喃（THF）/甲基乙基酮（MEK）配方。我国在 1964 年由锦西化工研究院研制成功，在锦西化工总厂投入生产。\par
...
不稳定氯原子是降低 CPVC 热稳定性的主要原因。目前，不稳定氯原子含量的唯一有效的测定方法是酚烷基化法\cite{16}。烯丙基氯与叔氯较一般的氯原子有较大的反应活性，它们均可与苯酚发生取代反应，如图 \ref{phenol}：
